<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin_dashboard.Master" AutoEventWireup="true" CodeFile="View_Contact.aspx.cs" Inherits="TMS_Project.Admin.View_Contact" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="GridView1" CssClass="table table-bordered tablle-hover table-dark table-striped " runat="server" AutoGenerateColumns="False" OnRowDeleting="GridView1_RowDeleting">
        <Columns>
