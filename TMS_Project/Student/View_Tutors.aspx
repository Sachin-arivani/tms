<%@ Page Title="" Language="C#" MasterPageFile="~/Student/student_dashboard.Master" AutoEventWireup="true" CodeFile="View_Tutors.aspx.cs" Inherits="TMS_Project.Student.View_Tutors" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
            <h1 class="jumbotron bg-dark text-white text-center ">TUTORS DATA DETAILS</h1>
        </div>
    </div>
